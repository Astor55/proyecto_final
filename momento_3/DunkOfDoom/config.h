...
static constexpr float VEL_JUGADOR        = 300.0f;
}

namespace NIVEL2
{
static constexpr float DURACION        = 90.0f;
static constexpr float VEL_JUGADOR     = 200.0f;
...
static constexpr const char* VICTORY1        = "assets/sprites/ui/you_win1.png";
static constexpr const char* GAME_OVER2      = "assets/sprites/ui/game_over2";
static constexpr const char* GAME_OVER1      = "assets/sprites/ui/game_over1.png";
